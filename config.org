...
#+begin_src emacs-lisp
  (use-package elpy
    ...
    (elpy-enable)
    :config
    (setq elpy-rpc-virtualenv-path '("~/.pyenv/versions/tools3")))
#+end_src

* Advanced Configuration
** WORKING =flyspell=                                          :LIKE:
...
See link on how to do this for Wiendows [[https://lists.gnu.org/archive/html/help-gnu-emacs/2014-04/msg00030.html][here]] and for Linux simply go to your distribution and install it there.
...
** REQ_FIXING Org template selector
...
#+BEGIN_SRC emacs-lisp
  (setq org-publish-project-alist
        '(
          ...
          ("thesis" :components ("thesis-main" "thesis-include" "thesis-figure"))))
#+end_src
...
| thesis-main      | :base-directory | /winc/jk/chalmers/courses/THESIS/thesis            | :publishing-directory | /winc/jk/chalmers/courses/THESIS/thesis/publish         | :publishing-function  | org-latex-publish-to-pdf                                   | :body-only | nil                   | :make-index                                            | nil                      |                  |                      |                        |                       |                                                |                   |   |                      |                        |                  |   |                |                  |                 |                   |
| thesis-include   | :base-directory | /winc/jk/chalmers/courses/THESIS/thesis/include    | :publishing-directory | /winc/jk/chalmers/courses/THESIS/thesis/publish/include | :publishing-function  | org-latex-publish-to-latex                                 | :body-only | t                     | :make-index                                            | nil                      |                  |                      |                        |                       |                                                |                   |   |                      |                        |                  |   |                |                  |                 |                   |
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-gcal-client-id "1008486205630-qqgcjb6rta6mqq927ie79eirotctnb4i.apps.googleusercontent.com"
      org-gcal-client-secret "_zQ6vzgi9VT_i0sEtoWxKErr"
      org-gcal-file-alist '(("jchkoch@gmail.com" .  "/winc/jk/myLife/gmail-gcal.org")
                            ("v22a08dfprtop40h0jal4fjub8@group.calendar.google.com" .  "/winc/jk/myLife/semester1-gcal.org")
                            ("cvof1nqr3od0k3mgs80lvvaeeg@group.calendar.google.com" . "/winc/jk/myLife/semester2-gcal.org")
                            ("cl0eq6809bdqqffib0fqe80bvc@group.calendar.google.com" . "/winc/jk/myLife/semester3-gcal.org")))
#+END_SRC

#+RESULTS:
: ((jchkoch@gmail.com . /winc/jk/myLife/gmail-gcal.org) (v22a08dfprtop40h0jal4fjub8@group.calendar.google.com . /winc/jk/myLife/semester1-gcal.org) (cvof1nqr3od0k3mgs80lvvaeeg@group.calendar.google.com . /winc/jk/myLife/semester2-gcal.org) (cl0eq6809bdqqffib0fqe80bvc@group.calendar.google.com . /winc/jk/myLife/semester3-gcal.org))

** REQ_FIXING =org-indent=
...
#+BEGIN_SRC emacs-lisp
  (use-package org-ref
    ...
    (require 'doi-utils)
    (require 'org-ref-pdf)
    (setq org-ref-bibliography-notes "/winc/jk/chalmers/courses/THESIS/references/notes.org"
          org-ref-default-bibliography '("/winc/jk/chalmers/courses/THESIS/references/references.bib")
          org-ref-pdf-directory "/winc/jk/chalmers/courses/THESIS/references/pdfs/")
