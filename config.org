...
(setq org-agenda-custom-commands
      '(("c" "Simple agenda view"
         ((tags "PRIORITY=\"A\""
          ...
          (tags "PRIORITY=\"B\""
                ((org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done))
                 (org-agenda-overriding-header "Lower-priority unfinished tasks:")))))))
#+END_SRC

#+RESULTS:
| c | Simple agenda view | ((tags PRIORITY="A" ((org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote todo) (quote done)))) (org-agenda-overriding-header High-priority unfinished tasks:))) (agenda ) (tags PRIORITY="B" ((org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote todo) (quote done)))) (org-agenda-overriding-header Lower-priority unfinished tasks:)))) |
...
(use-package org-habit
  ...
  :bind ("<f7>" . org-habit-toggle-habits))
#+END_SRC
...
(use-package cdlatex
  :ensure t
  :bind ("\C-c \C-g" . cdlatex-math-symbol)
