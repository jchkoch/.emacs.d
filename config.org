...
** DONE Which key mode
The ~which-key~ package offers tab suggestions/completions on key commands in case you can't remember the entire key sequence of the command you would like to execute.
...
*** DONE Python mode
Python mode to enable writing and running code with the ~python3~ interpreter in Emacs. See ~elpy-mode~ configuration in the [[* elpy-mode][next section]] for a basic IDE enviroment for auto-completion, syntax checking, etc.
...
*** DONE elpy-mode
~Elpy-mode~ to provide a better IDE-like enviroment in Emacs for editing and writing python code. Set the virtualenv for python to a specifically created default virtualenv for your user on the system. This is to not install python packages using ~pip~ into the system python under linux. For example, create a default python virtualenv under your home directory with the following configuration added to your ~.bashrc~ file.

#+begin_src sh
  source ~/py-base/bin/activate
#+end_src

Enable ~elpy-mode~ and set virtualenv path to the current system settings i.e. the base python virtualenv. Also, sets the python test runner to ~nose~ which must be installed in the base python virtualenv to work.
...
*** NEXT scimax ob-ipython

#+begin_src emacs-lisp
  (add-to-list 'load-path "~/.emacs.d/dev-pkgs/scimax/ob-ipython-upstream")
  (require 'ob-ipython)
  (add-to-list 'load-path "~/.emacs.d/dev-pkgs/scimax")
  (require 'scimax-ob)
  (add-to-list 'load-path "~/.emacs.d/dev-pkgs/scimax")
...
#+begin_src emacs-lisp
  (use-package ox
    ...
    (setq org-publish-project-alist
          '(
            ("org-index"
             :base-directory "/wind/jk/website/jckoch.gitlab.io/src" ;; specify full path as string
             :base-extension "org"
             :publishing-directory "/wind/jk/website/jckoch.gitlab.io/public_html"
             :recursive nil
            ...
            ("org-blog"
             :base-directory "/wind/jk/website/jckoch.gitlab.io/src/blog"
             :base-extension "org"
             :publishing-directory "/wind/jk/website/jckoch.gitlab.io/public_html/blog"
             :recursive t
             :publishing-function org-html-publish-to-html
             :htmlized-source t
             :html-postamble t
            ...
            ("org-portfolio"
             :base-directory "/wind/jk/website/jckoch.gitlab.io/src/portfolio"
             :base-extension "org"
             :publishing-directory "/wind/jk/website/jckoch.gitlab.io/public_html/portfolio"
             :recursive t
             :publishing-function org-html-publish-to-html
             :htmlized-source t
             :html-postamble t
            ...
            ("org-publications"
             :base-directory "/wind/jk/website/jckoch.gitlab.io/src/publications"
             :base-extension "org"
             :publishing-directory "/wind/jk/website/jckoch.gitlab.io/public_html/publications"
             :recursive nil
             :publishing-function org-html-publish-to-html
             :htmlized-source t
             :html-postamble t
            ...
            ("org-static"
             :base-directory "/wind/jk/website/jckoch.gitlab.io/src/"
            ...
            ("org-index-crkoch"
             :base-directory "/wind/jk/website/crkoch-ualberta-website/src" ;; or specify full path as string
             :base-extension "org"
             :publishing-directory "/wind/jk/website/crkoch-ualberta-website/public_html"
             :recursive nil
             :publishing-function org-html-publish-to-html
             :htmlized-source t
            ...
            ("org-research-crkoch"
             :base-directory "/wind/jk/website/crkoch-ualberta-website/src/research"
             :base-extension "org"
             :publishing-directory "/wind/jk/website/crkoch-ualberta-website/public_html/research"
             :recursive t
             :publishing-function org-html-publish-to-html
             :htmlized-source t
             :html-preamble my-html-preamble
            ...
            ("org-teaching-crkoch"
             :base-directory "/wind/jk/website/crkoch-ualberta-website/src/teaching"
             :base-extension "org"
             :publishing-directory "/wind/jk/website/crkoch-ualberta-website/public_html/teaching"
             :recursive t
             :publishing-function org-html-publish-to-html
             :htmlized-source t
             :html-preamble my-html-preamble
            ...
            ("org-publications-crkoch"
             :base-directory "/wind/jk/website/crkoch-ualberta-website/src/publications"
             :base-extension "org"
             :publishing-directory "/wind/jk/website/crkoch-ualberta-website/public_html/publications"
             :recursive nil
             :publishing-function org-html-publish-to-html
             :htmlized-source t
             :html-preamble my-html-preamble
            ...
            ("org-static-crkoch"
             :base-directory "/wind/jk/website/crkoch-ualberta-website/src/"
             :base-extension "css\\|js\\|png\\|jpg\\|gif\\|pdf\\|mp3\\|ogg\\|swf\\|html"
             :publishing-directory "/wind/jk/website/crkoch-ualberta-website/public_html/"
             :recursive t
             :publishing-function org-publish-attachment
            ...
            ("thesis-main"
             :base-directory "/wind/jk/chalmers/courses/THESIS/thesis"
             :publishing-directory "/wind/jk/chalmers/courses/THESIS/thesis/publish"
             :publishing-function org-latex-publish-to-latex
             :body-only nil
             :make-index nil
             )
            ("thesis-include"
             :base-directory "/wind/jk/chalmers/courses/THESIS/thesis/include"
             :base-extension "tex"
             :publishing-directory "/wind/jk/chalmers/courses/THESIS/thesis/publish/include"
             :recursive t
             :publishing-function org-publish-attachment
             :body-only t
             :make-index nil
            ...
            ("thesis-chapters"
             :base-directory "/wind/jk/chalmers/courses/THESIS/thesis/chapters"
             :publishing-directory "/wind/jk/chalmers/courses/THESIS/thesis/publish/chapters"
             :publishing-function org-latex-publish-to-latex
             :body-only t
             :make-index nil
             )
            ("thesis-figure"
             :base-directory "/wind/jk/chalmers/courses/THESIS/thesis/figure"
             :base-extension "png\\|jpg\\|gif\\|pdf"
             :publishing-directory "/wind/jk/chalmers/courses/THESIS/thesis/publish/figure"
             :recursive t
             :publishing-function org-publish-attachment
             )
            ("thesis"
...
#+BEGIN_SRC emacs-lisp
  (use-package org-ref
    ...
    (setq org-ref-bibliography-notes "/wind/jk/references/notes.org"
          org-ref-default-bibliography '("/wind/jk/references/references.bib")
          org-ref-pdf-directory "/wind/jk/references/pdfs/")
  
    (setq bibtex-completion-bibliography '("/wind/jk/references/references.bib")
          bibtex-completion-library-path '("/wind/jk/references/pdfs/")
          bibtex-completion-notes-path "/wind/jk/references/notes/"
...
#+end_quote
/--from  [[https://github.com/politza/pdf-tools/blob/master/README.org][pdf-tools GitHub Repository]]/

It should be noted in order for the program ~epdfinfo~ to be built and installed the following packages needed to be installed on the system where Emacs is installed. For convenience the following shell script is provided for the OS ~openSUSE~.

#+name: sh-script-pdf-tool-dependencies
#+begin_src sh
  su  # start a root session (beware of the dangers of running commands as the root user

  zypper in autoconf automake gcc gcc-c++  # installation of basic linux utilities i.e. GNU C Compiler etc.

  zypper in libpng16-devel zlib-devel libpoppler-glib-devel  # hard dependencies for pdf-tools
#+end_src

Note compared to the [[https://github.com/politza/pdf-tools/blob/master/README.org][README of the pdf-tool package]] that the dependencies are named slightly differently for the OS ~openSUSE~. For example, the endings of the package names for ~openSUSE~ are =-devel= not =-dev= and the =zlib1g-dev= package is named =zlib-devel= on ~openSUSE~. Additionally, the [[sh-script-pdf-tool-dependencies][script above]] requires ~openSUSE Leap 15.3~ running ~Emacs 27.2~. The package names may vary on older versions of ~openSUSE~.

The following configuration sets up the usage of ~pdf-tools~.
