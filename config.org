...
#+begin_src emacs-lisp
  ...
  (setq
     ...
     user-full-name  "James Koch"
     mu4e-compose-signature
      (concat
        "James Koch\n"
        "http://jckoch.gitlab.io\n"))
  ...
  (setq message-send-mail-function 'smtpmail-send-it
     ...
     smtpmail-auth-credentials
       '(("smtp.gmail.com" 587 "jchkoch@gmail.com" nil))
...
#+RESULTS:
| mu4e-alert-enable-notifications | mu4e-alert-enable-mode-line-display | #[0 \303\211\235\203 \304"\301\305!\210\210	\205 \306 \210\307\211\207 [command-line-args desktop-save-mode inhibit-startup-screen --no-desktop delete 0 desktop-read t] 4] | (lambda nil (setq debug-on-error nil)) | x-wm-set-size-hint | table--make-cell-map |
...
** =pamparam=
From [[https://github.com/abo-abo/pamparam][source repository]] by abo-abo on GitHub.

#+begin_src elisp
  (use-package pamparam
    :config
    (setq pamparam-path "/home/jkoch/Documents/languages/swedish/swedish.pam")
        ...
        '(
          ("org-index"
           ...
           :publishing-function org-html-publish-to-html
	         :html-preamble nil
           :html-style "<link rel=\"stylesheet\" type=\"text/css\" href=\"css/jckoch.com.min.css\" />"
           )
          ("org-blog"
...
#+RESULTS:
| org-index        | :base-directory | /winc/jk/website/jckoch.gitlab.io/src              | :base-extension | org  | :publishing-directory | /winc/jk/website/jckoch.gitlab.io/public_html              | :recursive | nil  | :publishing-function | org-html-publish-to-html | :html-preamble | nil  | :html-style | <link rel="stylesheet" type="text/css" href="css/jckoch.com.min.css" />    |                                                |            |   |                      |                        |
| org-blog         | :base-directory | /winc/jk/website/jckoch.gitlab.io/src/blog         | :base-extension | org  | :publishing-directory | /winc/jk/website/jckoch.gitlab.io/public_html/blog         | :recursive | t    | :publishing-function | org-html-publish-to-html | :html-preamble | t    | :html-style | <link rel="stylesheet" type="text/css" href="../css/jckoch.com.min.css" /> |                                                |            |   |                      |                        |
| org-publications | :base-directory | /winc/jk/website/jckoch.gitlab.io/src/publications | :base-extension | org  | :publishing-directory | /winc/jk/website/jckoch.gitlab.io/public_html/publications | :recursive | nil  | :publishing-function | org-html-publish-to-html | :html-preamble | t    |             |                                                                            |                                                |            |   |                      |                        |
...

=nA1Z
-----END PGP MESSAGE-----
