...
This allows for the window with the cursor inside it to be the largest (sized according to the mathematical [[https://en.wikipedia.org/wiki/Golden_ratio][Golden Ratio]].
Taken from the following [[http://pragmaticemacs.com/page/4/][blog post]].
