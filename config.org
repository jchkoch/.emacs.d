...
#+begin_src emacs-lisp
   (use-package ox
     ...
     (setq base-directory "/winc/jk/website/jckoch.gitlab.io/") ;; USER SPECIFIC
     ...
     (setq my-blog-header-file (concat base-directory "src/html-templates/level-0-header.html"))
     (setq  my-blog-footer-file (concat base-directory "src/html-templates/level-0-footer.html"))

     (setq org-publish-project-alist
           '(
             ("org-index"
              :base-directory (concat base-directory "/src") ;; or specify full path as string
              :base-extension "org"
              :publishing-directory (concat base-directory "public_html")
              :recursive nil
             ...
             ("org-navbar"
              :base-directory (concat base-directory "src/navbar-templates")
              :base-extension "org"
              :publishing-directory (concat base-directory "public_html/navbar-templates")
              :recursive nil
              :publishing-function org-html-publish-to-html
              :htmlized-source t
              :html-preamble my-html-preamble
             ...
             ("org-blog"
              :base-directory (concat base-directory "src/blog")
              :base-extension "org"
              :publishing-directory (concat base-directory "public_html/blog")
              :recursive t
              :publishing-function org-html-publish-to-html
              :htmlized-source t
              :html-preamble my-html-preamble
             ...
             ("org-portfolio"
              :base-directory (concat base-directory "src/portfolio")
              :base-extension "org"
              :publishing-directory (concat base-directory "public_html/portfolio")
              :recursive t
              :publishing-function org-html-publish-to-html
              :htmlized-source t
              :html-preamble my-html-preamble
             ...
             ("org-publications"
              :base-directory (concat base-directory "src/publications"
              :base-extension "org"
              :publishing-directory (concat base-directory "public_html/publications")
              :recursive nil
              :publishing-function org-html-publish-to-html
              :htmlized-source t
              :html-preamble my-html-preamble
             ...
             ("org-static"
              :base-directory (concat base-directory "src/")
...
** REVIEW Spaced repetition language learning

- State "REVIEW"     from "WAITING"    [2021-02-27 Sat 23:17]
#+begin_src emacs-lisp
