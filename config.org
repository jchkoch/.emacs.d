...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'after-change-major-mode-hook
            '(lambda ()
               (linum-mode (if (equal major-mode 'pdf-view-mode) 0 1))))
#+END_SRC

#+RESULTS:
| (lambda nil (linum-mode (if (equal major-mode (quote pdf-view-mode)) 0 1))) | global-undo-tree-mode-enable-in-buffers | delight-major-mode | global-linum-mode-enable-in-buffers | global-visual-line-mode-enable-in-buffers | global-font-lock-mode-enable-in-buffers |
** =org-crypt=
...
#+RESULTS:
| /winc/jk/myLife/gcal-sync/gmail-gcal.org | /winc/jk/myLife/gcal-sync/private-gcal.org | /winc/jk/myLife/gcal-sync/ualberta-gcal.org | /winc/jk/myLife/birthdays.org | /winc/jk/myLife/bob.org | /winc/jk/myLife/bom285.org | /winc/jk/myLife/chalmers.org | /winc/jk/myLife/contacts.org | /winc/jk/myLife/monika.org | /winc/jk/myLife/other.org | /winc/jk/myLife/refile.org | /winc/jk/myLife/todo.org | /winc/jk/myLife/vsm167.org |
